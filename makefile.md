...
For a complete manual on make, go to [The Make Manual][make-the-manual].

## Conventions

Many conventions are used in this manual. There are other ways to accomplish the same goals. Please keep this in mind and [git fork][git-fork] this project if you see ways to improve on it.
...
- **[Rules](#rules)** - Describes how to create a file (or type of file)
...
We have three files *add.h*, *add.cpp* and *main.cpp*. To build a program called add, we need to run g++ to compile and build the object files *add.cpp* and *main.cpp*.
...
On the command line, we would need to do something like this:
